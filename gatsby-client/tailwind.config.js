let makeShadow = (name, rgb) => {
  ...
  obj[
    name + "-md"
  ] = `0 4px 6px -1px rgba(${rgb}, 0.2), 0 2px 4px -1px rgba(${rgb}, 0.2)`;
  obj[
    name + "-lg"
  ] = `0 8px 10px -3px rgba(${rgb}, 0.2), 0 3px 5px -2px rgba(${rgb}, 0.2)`;
  obj[
    name + "-xl"
  ] = `0 20px 25px -5px rgba(${rgb}, 0.2), 0 10px 10px -5px rgba(${rgb}, 0.3)`;
